            ...
            <div className='container section-contact__container'>
                ...
                <ul className='section-contact__links-list'>
                    <li className='section-contact__links-item'>
                        <a href='mailto:kartikmhatre1812@gmail.com' className='section-contact__link'>
                    ...
                    <li className='section-contact__links-item'>
                        <a href='https://github.com/Kartikmhatre' target='_blank' rel='noopener noreferrer' className='section-contact__link'>
                            <span className='section-contact__link-text'>GitHub</span>
                            <span className='section-contact__link-icon'>
                                <Icon_arrow direction='diagonal' />
                            </span>
                        </a>
                    ...
                    <li className='section-contact__links-item'>
                        <a href='https://www.linkedin.com/in/kartik-mhatre-4768b238a/' target='_blank' rel='noopener noreferrer' className='section-contact__link'>
                    ...
                    <li className='section-contact__links-item'>
                        <a href='https://twitter.com/Kartikmhatre18' target='_blank' rel='noopener noreferrer' className='section-contact__link'>
                            <span className='section-contact__link-text'>Twitter</span>
                            <span className='section-contact__link-icon'>
                                <Icon_arrow direction='diagonal' />
                            </span>
                        </a>
