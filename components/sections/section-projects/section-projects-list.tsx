        ...
        <li className='section-projects__project'>
            ...
            <div className='section-projects__description-wrapper'>
                <div className='section-projects__description'>
                    <div className='section-projects__description-topside'>
                        ...
                        <div className='section-projects__features-wrapper'>
                            ...
                            <div className='section-projects__pricing-wrapepr'>
                                <span className='section-projects__params-name'>Visit Project:</span>
                                <a href={data.price} target='_blank' rel='noopener noreferrer' className='section-projects__params-value'>
                                    {data.price}
                                </a>
                            </div>
                        </div>
                    ...
                    <a href={data.price} target='_blank' rel='noopener noreferrer' className='section-projects__cta-button'>
                        Visit Project
                    </a>
                </div>
            </div>
