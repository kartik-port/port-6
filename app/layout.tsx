...
export const metadata = {
    title: 'Otisium - AI/ML Developer Portfolio',
    description: 'AI/ML Developer passionate about creating intelligent solutions',
};

export default function RootLayout({ children }: { children: React.ReactNode }) {
    return (
        <html lang='en' className={Muller.className}>
            <body>
